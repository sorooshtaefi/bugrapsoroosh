package com.vaadin.bugrap.views.main;
...
import com.vaadin.bugrap.views.report.ReportView;
...
public class MainView extends AppLayout {
    ...
    private Component createHeaderContent() {
        ...
        Button loggedInUser = new Button("Marc Manager", new Image("images/user.svg", "Avatar"));
        Button logout = new Button("Logout", VaadinIcon.KEY_O.create());
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Bugrap Soroosh logo"));
        logoLayout.add(new H1("Bugrap Soroosh"));
